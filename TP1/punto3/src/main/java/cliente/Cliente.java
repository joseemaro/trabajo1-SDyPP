...
public class Cliente {
	...
	public static void main(String[] args) {		
		try {
			...
			JOptionPane.showMessageDialog(null, "Error. Se debe haber caído el server.", "Error en el server.", JOptionPane.ERROR_MESSAGE);
		}		
	}
	...
	private static int mostrarMenuPrincipal(){
		...
		try {
			...
			JOptionPane.showMessageDialog(null,"Eso no. Se espera un número (0 para salir)");
